# Generated by Django 5.0.7 on 2025-02-27 22:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('savings', 'Savings'), ('current', 'Current'), ('fixed', 'Fixed Deposit')], default='savings', help_text='Type of bank account (e.g., Savings, Current, Fixed Deposit)', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.CharField(choices=[('Savings_Account', 'Savings Account'), ('Checking_Account', 'Checking Account')], default='Savings_Account', help_text='The account selected for deposit', max_length=50)),
